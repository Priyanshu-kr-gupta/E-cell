...
export default function UpcomingEvent() {
  ...
  if (!upcomingEvent.length) {
    return (
      <div className="w-full h-screen relative overflow-hidden z-0 border-[15px] border-[#2f4f4f] bg-[#202729]">
        ...
        <div className="flex flex-col items-center justify-center h-full">
          <div className="text-center text-white max-w-2xl px-6">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 mx-auto text-yellow-400 mb-6 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">No Upcoming Events</h2>
            <p className="text-lg sm:text-xl text-gray-300 mb-8">
              There are no upcoming events scheduled at the moment. Please check back later for new announcements.
            </p>
            <Link to="/events" className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-3 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2">
