    ...
    <section className="contact-section">
      <div className="container">
        <div className="section-header  mx-auto">
          ...
          <p className='mx-auto text-center sm:max-w-[1080px] mb-12 sm:text-[20px] text-sm max-w-md '>Welcome to the Entrepreneurship Cell at National institue of technology Jamshedpur! We value your interest and inquiries. Whether you're a student, an aspiring entrepreneur, or a potential collaborator, we're here to assist you.</p>
        </div>
